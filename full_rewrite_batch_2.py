#!/usr/bin/env python3
"""
Full rewrite - Batch 2 (listings 11-20)
- Process all accordions, extracting complete relevant sentences
"""
...
def main():
    print("=" * 80)
    print("FULL ACCORDION REWRITE - BATCH 2 (Listings 11-20)")
    ...
    # Process listings 11-20
    batch = listings[10:20]
